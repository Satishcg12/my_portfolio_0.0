...
const after = `after:content-[''] after:p-3 after:bg-black after:absolute after:-right-3 after:-bottom-3 after:animate-spining-ba `
const before = `before:content-[''] before:p-4 before:bg-black before:absolute before:-top-4 before:-left-4 before:animate-spining-ba `

export default function About() {
    return(
        <>
        <div className="flex justify-around items-center h-auto md:h-full md:p-20  p-14">
            <div className={`text-center border-2 border-dashed border-gray-400 relative p-10 md:p-24  ${after} ${before}`}>
